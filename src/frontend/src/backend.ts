...
export class Backend implements backendInterface {
    ...
    async getAllEnquiries(): Promise<Array<InsuranceEnquiry>> {
        if (this.processError) {
            try {
    ...
    async getAverageRating(): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getCallbackRequest(arg0: bigint): Promise<CallbackRequest> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallbackRequest(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEnquiry(arg0: bigint): Promise<InsuranceEnquiry> {
        if (this.processError) {
            try {
    ...
    async requestCallback(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.requestCallback(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitTestimonial(arg0: string, arg1: string, arg2: string | null, arg3: bigint): Promise<Testimonial> {
        if (this.processError) {
            try {
                const result = await this.actor.submitTestimonial(arg0, arg1, to_candid_opt_n24(this._uploadFile, this._downloadFile, arg2), arg3);
                return from_candid_Testimonial_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
